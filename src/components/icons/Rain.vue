<template>
  <svg v-if="iconDisplayStyle == 'svg'" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55.1 60" style="enable-background:new 0 0 55.1 49.5;" xml:space="preserve">
    <g id="Cloud_2">
      <g id="Rain_2">
  ...
  <img v-if="iconDisplayStyle == 'gif'" src="@/assets/icons8-rain.gif">
</template>
